...
if (isset($_POST['submit'])) {
    ...
    $jumlah = mysqli_query($db, "SELECT SUM(Aceh)  AS total_jumlah FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl'");
    $total = mysqli_fetch_array($jumlah);

    $jumlah1 = mysqli_query($db, "SELECT SUM(Bali)  AS total_jumlah1 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl' ");
    $total1 = mysqli_fetch_array($jumlah1);

    $jumlah2 = mysqli_query($db, "SELECT SUM(Banten)  AS total_jumlah2 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl' ");
    $total2 = mysqli_fetch_array($jumlah2);

    $jumlah3 = mysqli_query($db, "SELECT SUM(Babel)  AS total_jumlah3 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl' ");
    $total3 = mysqli_fetch_array($jumlah3);

    $jumlah4 = mysqli_query($db, "SELECT SUM(Bengkulu)  AS total_jumlah4 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl' ");
    $total4 = mysqli_fetch_array($jumlah4);

    $jumlah5 = mysqli_query($db, "SELECT SUM(DIY)  AS total_jumlah5 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl' ");
    $total5 = mysqli_fetch_array($jumlah5);

    $jumlah6 = mysqli_query($db, "SELECT SUM(Jakarta)  AS total_jumlah6 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl' ");
    $total6 = mysqli_fetch_array($jumlah6);

    $jumlah7 = mysqli_query($db, "SELECT SUM(Jambi)  AS total_jumlah7 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl' ");
    $total7 = mysqli_fetch_array($jumlah7);

    $jumlah8 = mysqli_query($db, "SELECT SUM(Jabar)  AS total_jumlah8 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl' ");
    $total8 = mysqli_fetch_array($jumlah8);

    $jumlah9 = mysqli_query($db, "SELECT SUM(Jateng)  AS total_jumlah9 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl' ");
    $total9 = mysqli_fetch_array($jumlah9);

    $jumlah10 = mysqli_query($db, "SELECT SUM(Jatim)  AS total_jumlah10 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl'");
    $total10 = mysqli_fetch_array($jumlah10);

    $jumlah11 = mysqli_query($db, "SELECT SUM(Kalbar)  AS total_jumlah11 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl' ");
    $total11 = mysqli_fetch_array($jumlah11);

    $jumlah12 = mysqli_query($db, "SELECT SUM(Kaltim)  AS total_jumlah12 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl'");
    $total12 = mysqli_fetch_array($jumlah12);

    $jumlah13 = mysqli_query($db, "SELECT SUM(Kalteng)  AS total_jumlah13 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl'");
    $total13 = mysqli_fetch_array($jumlah13);

    $jumlah14 = mysqli_query($db, "SELECT SUM(Kalsel)  AS total_jumlah14 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl'");
    $total14 = mysqli_fetch_array($jumlah14);

    $jumlah15 = mysqli_query($db, "SELECT SUM(Kaltara)  AS total_jumlah15 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl'");
    $total15 = mysqli_fetch_array($jumlah15);

    $jumlah16 = mysqli_query($db, "SELECT SUM(Kep_Riau)  AS total_jumlah16 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl' ");
    $total16 = mysqli_fetch_array($jumlah16);

    $jumlah17 = mysqli_query($db, "SELECT SUM(NTB)  AS total_jumlah17 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl'");
    $total17 = mysqli_fetch_array($jumlah17);

    $jumlah18 = mysqli_query($db, "SELECT SUM(Sumsel)  AS total_jumlah18 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl' ");
    $total18 = mysqli_fetch_array($jumlah18);

    $jumlah19 = mysqli_query($db, "SELECT SUM(Sumbar)  AS total_jumlah19 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl' ");
    $total19 = mysqli_fetch_array($jumlah19);

    $jumlah20 = mysqli_query($db, "SELECT SUM(Sulut)  AS total_jumlah20 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl'");
    $total20 = mysqli_fetch_array($jumlah20);

    $jumlah21 = mysqli_query($db, "SELECT SUM(Sumut)  AS total_jumlah21 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl' ");
    $total21 = mysqli_fetch_array($jumlah21);

    $jumlah22 = mysqli_query($db, "SELECT SUM(Sultra)  AS total_jumlah22 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl' ");
    $total22 = mysqli_fetch_array($jumlah22);

    $jumlah23 = mysqli_query($db, "SELECT SUM(Sulsel)  AS total_jumlah23 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl'");
    $total23 = mysqli_fetch_array($jumlah23);

    $jumlah24 = mysqli_query($db, "SELECT SUM(Sulteng)  AS total_jumlah24 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl'");
    $total24 = mysqli_fetch_array($jumlah24);

    $jumlah25 = mysqli_query($db, "SELECT SUM(Riau)  AS total_jumlah25 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl'");
    $total25 = mysqli_fetch_array($jumlah25);

    $jumlah26 = mysqli_query($db, "SELECT SUM(Malut)  AS total_jumlah26 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl' ");
    $total26 = mysqli_fetch_array($jumlah26);

    $jumlah27 = mysqli_query($db, "SELECT SUM(Maluku)  AS total_jumlah27 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl'");
    $total27 = mysqli_fetch_array($jumlah27);

    $jumlah28 = mysqli_query($db, "SELECT SUM(Papbar)  AS total_jumlah28 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl'");
    $total28 = mysqli_fetch_array($jumlah28);

    $jumlah29 = mysqli_query($db, "SELECT SUM(Papua)  AS total_jumlah29 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl'");
    $total29 = mysqli_fetch_array($jumlah29);

    $jumlah30 = mysqli_query($db, "SELECT SUM(Sulbar)  AS total_jumlah30 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl'");
    $total30 = mysqli_fetch_array($jumlah30);

    $jumlah31 = mysqli_query($db, "SELECT SUM(NTT)  AS total_jumlah31 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl'");
    $total31 = mysqli_fetch_array($jumlah31);

    $jumlah32 = mysqli_query($db, "SELECT SUM(Gorontalo)  AS total_jumlah32 FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl' ");
        ...
        <div class="row mt-4">
            <div class="col-md-12">
                <div class="alert alert-success" role="alert">
                    <strong>Jumlah Total Total Meninggal COVID-19 di Indonesia bulan Maret Sampai Oktober Tahun 2020</strong> <a href="#" class="alert-link"></a>
                </div>
            ...
            <table id="datatablesSimple" class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $filter = mysqli_query($db, "SELECT * FROM total_casualties WHERE Meninggal_Dunia BETWEEN '$dari_tgl' AND '$smp_tgl' ");
                    } else {
                        $filter = mysqli_query($db, "SELECT * FROM total_casualties");
                    }
                    ...
                    ?>
                        ...
                        <tr>
                            <td><?php echo $no++; ?></td>
                            <td><?php echo $row['Meninggal_Dunia']; ?></td>
